...
function jape_scripts() {
	wp_enqueue_style( 'cu-style', get_stylesheet_uri(), array(), _S_VERSION );
	wp_style_add_data( 'cu-style', 'rtl', 'replace' );

	wp_enqueue_script( 'cu-navigation', get_template_directory_uri() . '/js/navigation.js', array(), _S_VERSION, true );
